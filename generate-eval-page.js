...
<head>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .hero-banner{margin:-32px -28px 24px;border-radius:14px 14px 0 0;overflow:hidden;height:280px;}
    .hero-banner img{width:100%;height:100%;object-fit:cover;display:block;
      /* ✏️ 크롭 위치 조절: "수평 수직" 순서. 예) center top / center 30% / left center */
      object-position: center 40%;
    }
    .hero-eyebrow{font-size:12px;font-weight:700;color:#15803d;letter-spacing:.5px;text-transform:uppercase;margin-bottom:8px;}
    ...
    .grade-cnt{font-size:13px;font-weight:500;margin-left:8px;}
    .grade-body{padding:4px 20px 20px;}
    .org-group{margin-top:14px;}
    .group-label{font-size:11px;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px;padding-left:2px;}
    ...
    @media(max-width:500px){
      ...
      .hero-banner{margin:-24px -20px 20px;height:200px;}
