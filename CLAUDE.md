...
### 현재 작업 위치
- **마지막 완료**: 건강보험심사평가원(HIRA) 데이터 전면 업데이트 (세션13) — §4 세션13 참고. 그 직전엔 한국고용정보원(KEIS), 중소기업기술정보진흥원(TIPA), 한국관광공사 해외지사 좌표 5곳 개별 추가, 한국여성과학기술인육성재단(WISET), 한국해양진흥공사(KOBC), 창업진흥원(KISED), 한국투자공사(KIC), 그보다 앞서 모바일 지도 확대 토글 버그 2건 수정
