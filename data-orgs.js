const ORGS = [
  {
    ...
    "description": "세계 최대 LNG 수입 기업이자 국내 천연가스 공급 독점 공기업. 평균 연봉 1위 공기업.",
    "mainBusiness": [
      "LNG 도입·공급",
      "천연가스 인수기지 운영",
      "도시가스 공급",
    ...
    "branches": [
      ...
      {
        "name": "평택기지본부",
        "address": "경기도 평택시 포승읍 원정리 산109-402",
        "lat": 37.00115,
        "lng": 126.7952
      },
      {
      ...
      {
        "name": "통영기지본부",
        "address": "경남 통영시 광도면 안정리 1168-3",
        "lat": 34.9477,
        "lng": 128.4145
      },
      {
        "name": "삼척기지본부",
        "address": "강원특별자치도 삼척시 원덕읍 호산리 97",
        "lat": 37.1715,
        "lng": 129.3386
      },
      {
      ...
      {
        "name": "강원지역본부",
        "address": "강원도 원주시 단구로 423",
        "lat": 37.3422,
        "lng": 127.9496
      },
      {
        "name": "대전충청지역본부",
        "address": "대전광역시 중구 유등천동로 788",
        "lat": 36.3219,
        "lng": 127.3964
      },
      {
      ...
      {
        "name": "제주LNG본부",
        "address": "제주 제주시 애월읍 애월해안로 59-38",
        "lat": 33.4651,
        "lng": 126.3784
      },
      {
    ...
    "allBranches": [
      {
        ...
        "items": [
          ...
          { "name": "평택기지본부", "address": "경기 평택시 포승읍 원정리 산109-402" },
          { "name": "인천기지본부", "address": "인천 연수구 인천신항대로 960" },
          { "name": "통영기지본부", "address": "경남 통영시 광도면 안정리 1168-3" },
          { "name": "삼척기지본부", "address": "강원 삼척시 원덕읍 호산리 97" },
      ...
      },
      {
        ...
        "items": [
          ...
          { "name": "인천지역본부", "address": "인천 연수구 인천신항대로 960" },
          ...
          { "name": "광주전남지역본부", "address": "광주 광산구 손재로 368-21" },
          { "name": "대구경북지역본부", "address": "경북 경산시 진량읍 공단6로 122" },
          { "name": "부산경남지역본부", "address": "경남 김해시 김해대로2596번길 53" },
          { "name": "제주LNG본부", "address": "제주 제주시 애월읍 애월해안로 59-38" }
        ]
      },
      {
        "groupName": "홍보관",
        "items": [
          { "name": "에너지갤러리 청연 (대구)", "address": "대구 동구 첨단로 120" },
          { "name": "가스과학관 (인천)", "address": "인천 연수구 인천신항대로 960" },
          { "name": "천연가스홍보관 (통영)", "address": "경남 통영시 안정로 770" }
        ]
      },
      {
        "groupName": "연구소·연수원",
        "items": [
          { "name": "가스기술연구원 (안산)", "address": "경기 안산시 상록구 수인로 1248" },
          { "name": "가스기술연구원 (인천)", "address": "인천 연수구 인천신항대로 960" },
          { "name": "정선연수원", "address": "강원 정선군" }
        ]
      },
      {
        "groupName": "서울지역본부 산하 공급관리소 (22개)",
        "items": [
          { "name": "강서공급관리소", "address": "서울 강서구" },
          { "name": "양천공급관리소", "address": "서울 양천구" },
          { "name": "구로공급관리소", "address": "서울 구로구" },
          { "name": "금천공급관리소", "address": "서울 금천구" },
          { "name": "영등포공급관리소", "address": "서울 영등포구" },
          { "name": "동작공급관리소", "address": "서울 동작구" },
          { "name": "관악공급관리소", "address": "서울 관악구" },
          { "name": "서초공급관리소", "address": "서울 서초구" },
          { "name": "강남공급관리소", "address": "서울 강남구" },
          { "name": "송파공급관리소", "address": "서울 송파구" },
          { "name": "강동공급관리소", "address": "서울 강동구" },
          { "name": "마포공급관리소", "address": "서울 마포구" },
          { "name": "용산공급관리소", "address": "서울 용산구" },
          { "name": "성동공급관리소", "address": "서울 성동구" },
          { "name": "광진공급관리소", "address": "서울 광진구" },
          { "name": "중부공급관리소", "address": "서울 중구·종로구" },
          { "name": "동대문공급관리소", "address": "서울 동대문구" },
          { "name": "성북공급관리소", "address": "서울 성북구" },
          { "name": "강북공급관리소", "address": "서울 강북구" },
          { "name": "도봉공급관리소", "address": "서울 도봉구" },
          { "name": "노원공급관리소", "address": "서울 노원구" },
          { "name": "중랑공급관리소", "address": "서울 중랑구·서대문구·은평구" }
        ]
      },
      {
        "groupName": "인천지역본부 산하 공급관리소 (8개)",
        "items": [
          { "name": "인천서부공급관리소", "address": "인천 서구" },
          { "name": "인천남부공급관리소", "address": "인천 미추홀구·동구" },
          { "name": "부평공급관리소", "address": "인천 부평구" },
          { "name": "계양공급관리소", "address": "인천 계양구" },
          { "name": "연수공급관리소", "address": "인천 연수구" },
          { "name": "남동공급관리소", "address": "인천 남동구" },
          { "name": "강화공급관리소", "address": "인천 강화군" },
          { "name": "중구공급관리소", "address": "인천 중구·옹진군" }
        ]
      },
      {
        "groupName": "경기지역본부 산하 공급관리소 (31개)",
        "items": [
          { "name": "고양공급관리소", "address": "경기 고양시" },
          { "name": "파주공급관리소", "address": "경기 파주시" },
          { "name": "김포공급관리소", "address": "경기 김포시" },
          { "name": "부천공급관리소", "address": "경기 부천시" },
          { "name": "광명공급관리소", "address": "경기 광명시" },
          { "name": "시흥공급관리소", "address": "경기 시흥시" },
          { "name": "안산공급관리소", "address": "경기 안산시" },
          { "name": "수원공급관리소", "address": "경기 수원시" },
          { "name": "화성공급관리소", "address": "경기 화성시" },
          { "name": "평택공급관리소", "address": "경기 평택시" },
          { "name": "안성공급관리소", "address": "경기 안성시" },
          { "name": "오산공급관리소", "address": "경기 오산시" },
          { "name": "군포공급관리소", "address": "경기 군포시" },
          { "name": "안양공급관리소", "address": "경기 안양시" },
          { "name": "의왕공급관리소", "address": "경기 의왕시·과천시" },
          { "name": "성남공급관리소", "address": "경기 성남시" },
          { "name": "광주공급관리소", "address": "경기 광주시" },
          { "name": "하남공급관리소", "address": "경기 하남시" },
          { "name": "용인공급관리소", "address": "경기 용인시" },
          { "name": "이천공급관리소", "address": "경기 이천시" },
          { "name": "여주공급관리소", "address": "경기 여주시" },
          { "name": "양평공급관리소", "address": "경기 양평군" },
          { "name": "가평공급관리소", "address": "경기 가평군" },
          { "name": "남양주공급관리소", "address": "경기 남양주시" },
          { "name": "구리공급관리소", "address": "경기 구리시" },
          { "name": "의정부공급관리소", "address": "경기 의정부시" },
          { "name": "양주공급관리소", "address": "경기 양주시" },
          { "name": "동두천공급관리소", "address": "경기 동두천시" },
          { "name": "포천공급관리소", "address": "경기 포천시" },
          { "name": "연천공급관리소", "address": "경기 연천군" },
          { "name": "수원북부공급관리소", "address": "경기 수원시 북부" }
        ]
      },
      {
        "groupName": "강원지역본부 산하 공급관리소 (18개)",
        "items": [
          { "name": "춘천공급관리소", "address": "강원 춘천시" },
          { "name": "원주공급관리소", "address": "강원 원주시" },
          { "name": "강릉공급관리소", "address": "강원 강릉시" },
          { "name": "동해공급관리소", "address": "강원 동해시" },
          { "name": "태백공급관리소", "address": "강원 태백시" },
          { "name": "삼척공급관리소", "address": "강원 삼척시" },
          { "name": "속초공급관리소", "address": "강원 속초시" },
          { "name": "홍천공급관리소", "address": "강원 홍천군" },
          { "name": "횡성공급관리소", "address": "강원 횡성군" },
          { "name": "영월공급관리소", "address": "강원 영월군" },
          { "name": "평창공급관리소", "address": "강원 평창군" },
          { "name": "정선공급관리소", "address": "강원 정선군" },
          { "name": "철원공급관리소", "address": "강원 철원군" },
          { "name": "화천공급관리소", "address": "강원 화천군" },
          { "name": "양구공급관리소", "address": "강원 양구군" },
          { "name": "인제공급관리소", "address": "강원 인제군" },
          { "name": "고성공급관리소", "address": "강원 고성군" },
          { "name": "양양공급관리소", "address": "강원 양양군" }
        ]
      },
      {
        "groupName": "대전충청지역본부 산하 공급관리소 (30개)",
        "items": [
          { "name": "대전공급관리소", "address": "대전광역시" },
          { "name": "세종공급관리소", "address": "세종특별자치시" },
          { "name": "천안공급관리소", "address": "충남 천안시" },
          { "name": "아산공급관리소", "address": "충남 아산시" },
          { "name": "공주공급관리소", "address": "충남 공주시" },
          { "name": "계룡공급관리소", "address": "충남 계룡시" },
          { "name": "논산공급관리소", "address": "충남 논산시" },
          { "name": "금산공급관리소", "address": "충남 금산군" },
          { "name": "서산공급관리소", "address": "충남 서산시" },
          { "name": "당진공급관리소", "address": "충남 당진시" },
          { "name": "홍성공급관리소", "address": "충남 홍성군" },
          { "name": "예산공급관리소", "address": "충남 예산군" },
          { "name": "태안공급관리소", "address": "충남 태안군" },
          { "name": "보령공급관리소", "address": "충남 보령시" },
          { "name": "청양공급관리소", "address": "충남 청양군" },
          { "name": "서천공급관리소", "address": "충남 서천군" },
          { "name": "부여공급관리소", "address": "충남 부여군" },
          { "name": "청주공급관리소", "address": "충북 청주시" },
          { "name": "충주공급관리소", "address": "충북 충주시" },
          { "name": "제천공급관리소", "address": "충북 제천시" },
          { "name": "음성공급관리소", "address": "충북 음성군" },
          { "name": "진천공급관리소", "address": "충북 진천군" },
          { "name": "괴산공급관리소", "address": "충북 괴산군" },
          { "name": "증평공급관리소", "address": "충북 증평군" },
          { "name": "보은공급관리소", "address": "충북 보은군" },
          { "name": "옥천공급관리소", "address": "충북 옥천군" },
          { "name": "영동공급관리소", "address": "충북 영동군" },
          { "name": "단양공급관리소", "address": "충북 단양군" },
          { "name": "천안북부공급관리소", "address": "충남 천안시 북부" },
          { "name": "청주북부공급관리소", "address": "충북 청주시 북부" }
        ]
      },
      {
        "groupName": "전북지역본부 산하 공급관리소 (14개)",
        "items": [
          { "name": "전주공급관리소", "address": "전북 전주시" },
          { "name": "완주공급관리소", "address": "전북 완주군" },
          { "name": "군산공급관리소", "address": "전북 군산시" },
          { "name": "익산공급관리소", "address": "전북 익산시" },
          { "name": "정읍공급관리소", "address": "전북 정읍시" },
          { "name": "김제공급관리소", "address": "전북 김제시" },
          { "name": "남원공급관리소", "address": "전북 남원시" },
          { "name": "고창공급관리소", "address": "전북 고창군" },
          { "name": "부안공급관리소", "address": "전북 부안군" },
          { "name": "순창공급관리소", "address": "전북 순창군" },
          { "name": "임실공급관리소", "address": "전북 임실군" },
          { "name": "장수공급관리소", "address": "전북 장수군" },
          { "name": "무주공급관리소", "address": "전북 무주군" },
          { "name": "진안공급관리소", "address": "전북 진안군" }
        ]
      },
      {
        "groupName": "광주전남지역본부 산하 공급관리소 (22개)",
        "items": [
          { "name": "광주공급관리소", "address": "광주광역시" },
          { "name": "광주북구공급관리소", "address": "광주 북구" },
          { "name": "나주공급관리소", "address": "전남 나주시" },
          { "name": "목포공급관리소", "address": "전남 목포시" },
          { "name": "영암공급관리소", "address": "전남 영암군" },
          { "name": "무안공급관리소", "address": "전남 무안군" },
          { "name": "함평공급관리소", "address": "전남 함평군" },
          { "name": "영광공급관리소", "address": "전남 영광군" },
          { "name": "장성공급관리소", "address": "전남 장성군" },
          { "name": "담양공급관리소", "address": "전남 담양군" },
          { "name": "화순공급관리소", "address": "전남 화순군" },
          { "name": "순천공급관리소", "address": "전남 순천시" },
          { "name": "여수공급관리소", "address": "전남 여수시" },
          { "name": "광양공급관리소", "address": "전남 광양시" },
          { "name": "구례공급관리소", "address": "전남 구례군" },
          { "name": "고흥공급관리소", "address": "전남 고흥군" },
          { "name": "보성공급관리소", "address": "전남 보성군" },
          { "name": "장흥공급관리소", "address": "전남 장흥군" },
          { "name": "강진공급관리소", "address": "전남 강진군" },
          { "name": "해남공급관리소", "address": "전남 해남군" },
          { "name": "완도공급관리소", "address": "전남 완도군" },
          { "name": "진도공급관리소", "address": "전남 진도군" }
        ]
      },
      {
        "groupName": "대구경북지역본부 산하 공급관리소 (24개)",
        "items": [
          { "name": "대구공급관리소", "address": "대구광역시" },
          { "name": "대구북구공급관리소", "address": "대구 북구" },
          { "name": "경산공급관리소", "address": "경북 경산시" },
          { "name": "칠곡공급관리소", "address": "경북 칠곡군" },
          { "name": "성주공급관리소", "address": "경북 성주군" },
          { "name": "고령공급관리소", "address": "경북 고령군" },
          { "name": "청도공급관리소", "address": "경북 청도군" },
          { "name": "영천공급관리소", "address": "경북 영천시" },
          { "name": "경주공급관리소", "address": "경북 경주시" },
          { "name": "포항공급관리소", "address": "경북 포항시" },
          { "name": "영덕공급관리소", "address": "경북 영덕군" },
          { "name": "청송공급관리소", "address": "경북 청송군" },
          { "name": "영양공급관리소", "address": "경북 영양군" },
          { "name": "안동공급관리소", "address": "경북 안동시" },
          { "name": "의성공급관리소", "address": "경북 의성군" },
          { "name": "군위공급관리소", "address": "경북 군위군" },
          { "name": "구미공급관리소", "address": "경북 구미시" },
          { "name": "김천공급관리소", "address": "경북 김천시" },
          { "name": "상주공급관리소", "address": "경북 상주시" },
          { "name": "문경공급관리소", "address": "경북 문경시" },
          { "name": "예천공급관리소", "address": "경북 예천군" },
          { "name": "영주공급관리소", "address": "경북 영주시" },
          { "name": "봉화공급관리소", "address": "경북 봉화군" },
          { "name": "울진공급관리소", "address": "경북 울진군" }
        ]
      },
      {
        "groupName": "부산경남지역본부 산하 공급관리소 (20개)",
        "items": [
          { "name": "부산공급관리소", "address": "부산광역시" },
          { "name": "부산북부공급관리소", "address": "부산 북구·사상구" },
          { "name": "부산동부공급관리소", "address": "부산 동래구·해운대구" },
          { "name": "울산공급관리소", "address": "울산광역시" },
          { "name": "양산공급관리소", "address": "경남 양산시" },
          { "name": "김해공급관리소", "address": "경남 김해시" },
          { "name": "창원공급관리소", "address": "경남 창원시" },
          { "name": "밀양공급관리소", "address": "경남 밀양시" },
          { "name": "거제공급관리소", "address": "경남 거제시" },
          { "name": "진주공급관리소", "address": "경남 진주시" },
          { "name": "사천공급관리소", "address": "경남 사천시" },
          { "name": "통영공급관리소", "address": "경남 통영시" },
          { "name": "고성공급관리소", "address": "경남 고성군" },
          { "name": "남해공급관리소", "address": "경남 남해군" },
          { "name": "하동공급관리소", "address": "경남 하동군" },
          { "name": "산청공급관리소", "address": "경남 산청군" },
          { "name": "함양공급관리소", "address": "경남 함양군" },
          { "name": "거창공급관리소", "address": "경남 거창군" },
          { "name": "합천공급관리소", "address": "경남 합천군" },
          { "name": "함안공급관리소", "address": "경남 함안군·창녕군·의령군" }
        ]
      },
      {
        "groupName": "제주LNG본부 산하 공급관리소 (2개)",
        "items": [
          { "name": "제주공급관리소", "address": "제주 제주시" },
          { "name": "서귀포공급관리소", "address": "제주 서귀포시" }
        ]
      }
    ]
  },
  {
    ...
    "description": "대한민국 최대 공기업. 전력 송배전 및 판매를 독점하는 전력산업의 중심.",
    "mainBusiness": [
      "전력 송변전·배전",
      "전력 판매",
      "해외 발전사업",
  ...
  },
  {
    ...
    "description": "원자력·수력 발전을 담당하는 한전 자회사. 국내 전력 생산의 30% 이상 담당.",
    "mainBusiness": [
      "원자력발전 운영",
      "수력·양수발전",
      "신재생에너지",
  ...
  },
  {
    ...
    "description": "한전 발전자회사 5사 중 하나. 보령·서천·인천 화력발전소 운영.",
    "mainBusiness": [
      "화력발전소 운영",
      "신재생에너지",
      "해외발전사업",
  ...
  },
  {
    ...
    "description": "한전 발전자회사. 태안·평택·서인천 등 발전소 운영.",
    "mainBusiness": [
      "화력발전 운영",
      "IGCC·수소발전",
      "신재생에너지",
  ...
  },
  {
    ...
    "description": "한전 발전자회사. 울산·당진·동해 등 화력발전소 운영.",
    "mainBusiness": [
      "화력발전 운영",
      "신재생에너지",
      "해외사업",
  ...
  },
  {
    ...
    "description": "1985년 설립된 집단에너지 공기업. 지역냉난방·열병합발전·신재생에너지 사업.",
    "mainBusiness": [
      "지역냉난방 공급",
      "열병합발전",
      "신재생에너지",
  ...
  },
  {
    ...
    "description": "동북아 허브공항 인천국제공항을 운영하는 공기업. 세계 최고 수준의 공항 서비스.",
    "mainBusiness": [
      "인천공항 운영·관리",
      "공항건설·유지보수",
      "공항 주변 개발",
  ...
  },
  {
    ...
    "recruitUrl": "https://job.alio.go.kr/recruit.do?keyword=한국공항공사",
    "description": "전국 14개 지방공항을 통합 관리하는 공기업. 인천공항 제외 국내 공항 운영.",
    "mainBusiness": [
      "공항시설 관리·운영",
      "항행안전시설 설치·운영",
      "항공보안 업무",
  ...
  },
  {
    ...
    "recruitUrl": "https://job.alio.go.kr/recruit.do?keyword=한국석유공사",
    "description": "석유 자원 개발 및 비축을 담당하는 공기업. 에너지 안보 확보 핵심 기관.",
    "mainBusiness": [
      "석유 비축·관리",
      "해외 자원개발",
      "석유유통 가격공시",
  ...
  },
  {
    ...
    "recruitUrl": "https://job.alio.go.kr/recruit.do?keyword=한국토지주택공사",
    "description": "공공주택 건설·공급 및 도시개발을 담당하는 공기업. 주거복지 핵심 기관.",
    "mainBusiness": [
      "공공주택 건설·공급",
      "신도시 개발",
      "임대주택 운영",
  ...
  },
  {
    ...
    "recruitUrl": "https://job.alio.go.kr/recruit.do?keyword=한국조폐공사",
    "description": "화폐, 신분증, 여권 등 국가보안제품을 제조하는 공기업.",
    "mainBusiness": [
      "은행권·주화 제조",
      "신분증·여권 제작",
      "ID 보안 솔루션",
  ...
  },
  {
    ...
    "recruitUrl": "https://job.alio.go.kr/recruit.do?keyword=한국마사회",
    "description": "한국 경마 산업을 운영·관리하는 공기업. 축산발전기금 기여.",
    "mainBusiness": [
      "경마사업 운영",
      "말산업 육성",
      "축산발전기금 조성",
