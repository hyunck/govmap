  ...
  },
  {
    ...
    "allBranches": [
      ...
      },
      {
        ...
        "items": [
          {"name": "인천지역본부", "address": "인천 남동구 논현로46번길 23"},
          {"name": "청라영종사업본부", "address": "인천 서구 청라커낼로 127"},
          {"name": "계양부천사업본부", "address": "인천 계양구 봉오대로 838"},
          {"name": "검단사업본부", "address": "인천 서구 원당대로 1039"},
          {"name": "경기남부지역본부", "address": "경기 성남시 분당구 성남대로54번길 3"},
          {"name": "용인사업본부", "address": "경기 용인시 처인구 이동읍 원천로41번길 4"},
          {"name": "경기북부지역본부", "address": "경기 의정부시 산단로76번길 116"},
          {"name": "고양사업본부", "address": "경기 고양시 덕양구 항공대학로 76"},
          {"name": "하남사업본부", "address": "경기 하남시 미사대로 520"},
          {"name": "남양주사업본부", "address": "경기 남양주시 다산순환로 21"},
          {"name": "파주사업본부", "address": "경기 파주시 야당역로 9"},
          {"name": "양주사업본부", "address": "경기 양주시 옥정중앙로 59"}
        ]
      },
      {
        "groupName": "강원·충청권",
        "items": [
          ...
          {"name": "세종특별본부", "address": "세종 가름로 238-3"},
          {"name": "대전충남지역본부", "address": "대전 서구 둔산중로 108"},
          {"name": "천안아산사업단", "address": "충남 아산시 배방읍 장재리 1488"}
        ]
      },
      {
        "groupName": "호남권",
      ...
      },
      {
        ...
        "items": [
          {"name": "대구경북지역본부", "address": "대구 달서구 상화로 272"},
          {"name": "경남지역본부", "address": "경남 창원시 성산구 중앙대로 215"},
          {"name": "양산사업단", "address": "경남 양산시 물금읍 범어로 12"},
          {"name": "진주사천사업단", "address": "경남 진주시 충의로 19"},
          {"name": "부산울산지역본부", "address": "부산 동구 중앙대로 224"}
        ]
      },
      {
